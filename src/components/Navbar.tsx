...
const links = [
  { href: "/flat-rate-junk-pickup", label: "Home" },
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo */}
          <Link href="/flat-rate-junk-pickup" className="flex items-center gap-2 group">
            ...
            <span className="text-stone-50 font-black text-lg tracking-tight">
              Trailer<span className="text-orange-500">Trucks</span>Junk
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/contact"
              className="border border-stone-600 hover:border-orange-500 hover:text-orange-400 text-stone-300 text-sm font-bold uppercase tracking-wide px-5 py-2.5 rounded-sm transition-all duration-200"
            >
              Contact Us
            </Link>
            <a
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${open ? "max-h-96 pb-6" : "max-h-0"}`}>
          <div className="border-t border-stone-800 pt-4 flex flex-col gap-1">
            {links.map(({ href, label }) => (
              <Link
                ...
                className={`px-2 py-3 text-base font-semibold transition-colors duration-200 ${
                  pathname === href ? "text-orange-500" : "text-stone-400 hover:text-stone-50"
                }`}
              >
                {label}
              </Link>
            ...
            <div className="pt-3 flex flex-col gap-2">
              <Link
                href="/contact"
                className="block text-center border border-stone-600 text-stone-300 text-sm font-bold uppercase tracking-wide px-5 py-3 rounded-sm transition-all duration-200"
              >
                Contact Us
              </Link>
              <a
